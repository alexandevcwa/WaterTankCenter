...
import com.miumg.wtcenter.dto.TankDto;
...
public class WaterTankService {
     ...
     * <p>
     * The method uses the {@code SimpMessagingTemplate} to send a {@link TankDto} object containing
     ...
     * <p>
     * The method gathers the above information through the injected {@link TankLink} instance,
    ...
    public void emitTankStatus() {
        simpMessagingTemplate.convertAndSend("/topic/tank-status",
                new TankDto("T1",
                        tankLink.getMinimumVolume(),
                        tankLink.getMaximumVolume(),
                        tankLink.getCurrentVolume(),
                        tankLink.getRadio(),
                        tankLink.getHight()));
